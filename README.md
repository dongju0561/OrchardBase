...
The mobile device and Hub (Raspberry-Pi) take commands from users and share that information on Firebase. Arduino, which is connected by various actuators and sensors, and Hub communicate through Bluetooth.
